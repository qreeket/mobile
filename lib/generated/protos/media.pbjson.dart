...
const UploadMediaRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.qreeket.MediaType', '10': 'type'},
...
final $typed_data.Uint8List uploadMediaRequestDescriptor = $convert.base64Decode('ChJVcGxvYWRNZWRpYVJlcXVlc3QSFAoFbWVkaWEYASABKAxSBW1lZGlhEiYKBHR5cGUYAiABKA4yEi5xcmVla2V0Lk1lZGlhVHlwZVIEdHlwZRIXCgRuYW1lGAMgASgJSABSBG5hbWWIAQESGQoFb3duZXIYBCABKAlIAVIFb3duZXKIAQFCBwoFX25hbWVCCAoGX293bmVy');
...
final $typed_data.Uint8List uploadMediaResponseDescriptor = $convert.base64Decode('ChNVcGxvYWRNZWRpYVJlc3BvbnNlEhAKA3VybBgBIAEoCVIDdXJsEhIKBHNpemUYAiABKA1SBHNpemU=');
