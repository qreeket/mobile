...
import 'package:hive_flutter/adapters.dart' as _i33;
...
import 'package:mobile/features/groups/data/remote/data_sources/group.dart'
    as _i29;
import 'package:mobile/features/groups/data/repositories/channel.dart' as _i38;
import 'package:mobile/features/groups/data/repositories/group.dart' as _i40;
import 'package:mobile/features/groups/domain/repositories/channel.dart'
    as _i37;
import 'package:mobile/features/groups/domain/repositories/group.dart' as _i39;
...
import 'package:mobile/features/groups/presentation/manager/group_bloc.dart'
    as _i17;
import 'package:mobile/features/onboarding/data/local/auth.dart' as _i32;
import 'package:mobile/features/onboarding/data/remote/auth.dart' as _i34;
import 'package:mobile/features/onboarding/data/repositories/auth.dart' as _i36;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i23.BaseNotificationRepository>(_i24.NotificationRepository(
    ...
    gh.factory<_i32.AuthLocalDataSource>(() => _i32.AuthLocalDataSource(
          gh<_i33.Box<_i6.Account>>(),
          gh<_i33.Box<_i6.Country>>(),
          gh<_i33.Box<_i6.College>>(),
          gh<_i25.BaseSecurityRepository>(),
        ));
    gh.factory<_i34.AuthRemoteDataSource>(() => _i34.AuthRemoteDataSource(
          gh<_i25.BaseSecurityRepository>(),
    ...
    gh.factory<_i35.BaseAuthRepository>(() => _i36.AuthRepository(
          gh<_i20.NetworkInfo>(),
          gh<_i34.AuthRemoteDataSource>(),
          gh<_i32.AuthLocalDataSource>(),
        ));
    gh.factory<_i37.BaseChannelRepository>(() => _i38.ChannelRepository(
          gh<_i20.NetworkInfo>(),
          gh<_i27.ChannelRemoteDataSource>(),
          gh<_i8.ChannelLocalDataSource>(),
        ));
    gh.factory<_i39.BaseGroupRepository>(() => _i40.GroupRepository(
