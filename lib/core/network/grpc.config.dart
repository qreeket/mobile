...
class NetworkServerConfig {
  ...
  static List<ClientInterceptor> get _createInterceptors => [TokenGrpcInterceptor(), LogGrpcInterceptor()];
  ...
  static AuthServiceClient createAuthClient() =>
      AuthServiceClient(createChannel(Env.kAuthClientHost, Env.kAuthClientPort), interceptors: _createInterceptors);

  static SmsServiceClient createSmsClient() =>
      SmsServiceClient(createChannel(Env.kSmsClientHost, Env.kSmsClientPort), interceptors: _createInterceptors);

  static GroupServiceClient createGroupClient() =>
      GroupServiceClient(createChannel(Env.kGroupClientHost, Env.kGroupClientPort), interceptors: _createInterceptors);

  static ChannelServiceClient createChannelClient() =>
      ChannelServiceClient(createChannel(Env.kGroupClientHost, Env.kGroupClientPort),
          interceptors: _createInterceptors);

  static NotificationServiceClient createNotificationClient() =>
      NotificationServiceClient(createChannel(Env.kNotificationClientHost, Env.kNotificationClientPort),
          interceptors: _createInterceptors);
}
